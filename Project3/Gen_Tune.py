...
class Discrete_Params():
    ...
    def crossover(self, parent2):
        ...
        child1 = Discrete_Params(self.val*beta + parent2.val*(1-beta))
        child2 = Discrete_Params(parent2.val*beta + self.val*(1-beta))
    ...
    for pop in range(init_size):
        ...
        for param in parameters:
            ...
            if param[0] == 0:
                ...
                individual = np.append(individual, Discrete_Params(rng.choice(list(range(param[1], param[2] + 1)), size = param[3])))
                ...
                individual = np.append(individual, Real_Params(rng.uniform(param[1], param[2], param[3])))
